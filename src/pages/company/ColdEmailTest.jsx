  ...
  return (
    <div className="page-wrap" style={{ padding: '40px 48px', maxWidth: 900, animation: 'fadeUp 0.5s ease both' }}>
      <div style={{ marginBottom: 32 }}>
        <div style={{ fontSize: 12, fontFamily: 'var(--font-sans)', color: 'var(--text-2)', marginBottom: 8, letterSpacing: '0.1em' }}>COLD EMAIL TEST</div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 20 }}>
            ...
            {createStep < STEPS.length - 1 ? (
              ...
              <Btn onClick={() => setShowSubmitConfirm(true)} disabled={teamRole === 'viewer' || submitting || !emailText.trim() || (creditsChargedOnSubmit && creditBalance != null && calcCredits(panelSize, careerLevels, 'sub') > creditBalance)}>
            ...
            desc={
              <div style={{ fontSize: 13, color: 'var(--text-2)', lineHeight: 1.75 }}>
                ...
                <div style={{ padding: '10px 14px', background: 'rgba(16,54,125,0.06)', borderRadius: 8, marginBottom: 12 }}>
                  ...
                  <div>이메일의 발송 목적과 타겟 맥락을 <strong>구체적으로 작성할수록</strong> 패널이 실제 수신자 관점의 날카로운 피드백을 제공합니다. 제출 전 제품 설명을 다시 한번 확인하세요.</div>
                </div>
                <div style={{ fontSize: 12, color: 'var(--text-3)' }}>
