...
2. `agent/MR_스티브_guide.txt` — 스티브 행동 강령 (인풋 기준 이해 — Nova는 스티브 산출물을 인풋으로 받음)
...
작업 완료 시 `c:/Users/gnb_system/Desktop/Purit/purit-marketer-agent/memory/team_memory.txt`에 기록하고 `agent/MP_잡스_guide.txt` LEARNED 섹션을 업데이트할 것.
