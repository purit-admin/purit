-- 021_badge_system_v2.sql
-- 12개 계층형 뱃지 시스템 v2
-- panels.selected_badge 컬럼 추가 + check_and_award_badges RPC

-- ── 1. panels 테이블: selected_badge 컬럼 추가 ──────────────────────────────────
ALTER TABLE panels ADD COLUMN IF NOT EXISTS selected_badge TEXT DEFAULT NULL;

-- ── 2. check_and_award_badges RPC ────────────────────────────────────────────────
-- 본인 또는 어드민만 호출 가능 (020 패턴 동일)
