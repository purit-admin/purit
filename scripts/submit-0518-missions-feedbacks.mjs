 ...
 * - 5대 지표 이미지/텍스트 어노테이션 + 총평 + LP 추가 질문 응답
...
const OVERALL_HIGH = [
  ...
  '5대 지표 평가 방법론이 페이지 전반에 일관되게 표현되어 있고, 가격 플랜 비교 테이블이 명확해 의사결정을 돕습니다. 무료 체험이나 파일럿 제안 섹션이 추가된다면 도입 장벽을 낮출 수 있을 것입니다.',
